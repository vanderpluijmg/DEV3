/*!
 * \file item_incomplete.h
 *
 * \brief Définition de la classe nvs::lotto::Item ainsi que
 *        de fonctions associées.
 */
#ifndef ITEM_INCOMPLETE_H
#define ITEM_INCOMPLETE_H
...
class Item
{
     ...
     */
    const g54786::lotto::Parameter & parameter_;
  ...
  public:
    ...
    inline explicit Item(const Container & values,
                         const g54786::lotto::Parameter & parameter);
     ...
     *         élément de lotto.
     */
    inline const g54786::lotto::Parameter & parameter() const;
...
void Item::checkValues() const{
    ...
    if (parameter_.maximum() != *(values_.rbegin()) && parameter_.minimum() != *values_.begin())
        throw std::invalid_argument { "value error" };
}

template<typename Container>
Item::Item(const Container & values, const g54786::lotto::Parameter & parameter) :
...
const g54786::lotto::Parameter & Item::parameter() const
{
    return parameter_;
}
