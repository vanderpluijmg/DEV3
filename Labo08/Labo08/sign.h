 ...
 */
#ifndef LABO08_SIGN_H
#define LABO08_SIGN_H

#include <string>
#include <ostream>

/*!
 * \brief Sign namespace identifiant.
 */
namespace g54786 {
...
/*!
 * \brief Fonction retournant le signe produit de deux 54786::Sign.
 *
 * La [règle des signes]
 ...
 */
    ...
    constexpr Sign product(Sign lhs, Sign rhs) {
        if (rhs==Sign::ZERO|| lhs== Sign::ZERO)
            return Sign::ZERO;
        if (opposite(lhs) == rhs)
            return Sign::MINUS;
        return Sign::PLUS;
