...
// implémentation de fonctions inline
    ...
    inline Fraction abs(const Fraction &fraction) {
        ...
        -1*(fraction.numerator()/fraction.denominator()) : fraction.numerator()/fraction.denominator();
    }
    ...
    inline std::string to_string(const Fraction &fraction) {
        return fraction.denominator() == 1 ? std::to_string(fraction.numerator()) :
    ...
    inline std::ostream &operator<<(std::ostream &out, const Fraction &fraction) {
        ...
        return  out<<to_string(fraction)<<std::endl;
    }
